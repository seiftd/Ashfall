  ...
  return (
    <div className="flex-1 p-8 overflow-auto z-20 max-w-4xl mx-auto">
      ...
      <div className="space-y-8 text-slate-300 font-sans leading-relaxed">
        ...
        <section className="bg-slate-900/80 p-6 border-s-4 border-blue-500 rounded-e-lg">
           <h3 className="text-2xl font-bold text-white mb-2 flex items-center gap-2">
             <Brain size={24} className="text-blue-500" />
             {t.ai_title}
           </h3>
           <div className="text-sm font-mono text-blue-500 mb-6">{t.ai_subtitle}</div>
           ...
           <div className="mb-8">
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
               <div className="bg-blue-950/30 p-4 border border-blue-900/50 rounded">
             ...
             <div className="space-y-4">
               <div className="bg-slate-950 p-4 rounded border-s-2 border-slate-700">
                 ...
                 <div className="font-mono text-xs text-slate-400" dir="ltr">
                   ROOT <br/>
                   ├── <span className="text-emerald-500">Self_Preservation</span> (Health &lt; 30%? → Retreat/Heal)<br/>
                   ├── <span className="text-amber-500">Combat_Logic</span> (Has Target?)<br/>
                   │   ├── Is Suppressed? → Hunker Down<br/>
                   │   ├── Can Flank? → Move to Flank Node<br/>
                   │   └── <span className="text-red-500">Engage</span> (Fire / Grenade)<br/>
                   └── <span className="text-blue-500">Idle_State</span> (Patrol / Guard)
                 </div>
               </div>
               <div className="bg-slate-950 p-4 rounded border-s-2 border-slate-700">
                 ...
                 <div className="font-mono text-xs text-slate-400" dir="ltr">
                   ROOT <br/>
                   ├── <span className="text-red-500">Enrage_Check</span> (Taken Damage? → Roar & Charge)<br/>
                   ├── <span className="text-amber-500">Hunt_Logic</span> (Smell Player?)<br/>
                   │   ├── Stealth_Approach (Avoid Line of Sight)<br/>
                   │   └── Ambush_Leap<br/>
                   └── <span className="text-blue-500">Wander</span> (Territory Patrol)
                 </div>
               </div>
             </div>
           </div>
           ...
           <div className="mb-8">
             ...
             <div className="bg-black/40 p-4 rounded border border-slate-700 font-mono text-xs text-slate-300">
               <div className="mb-2" dir="ltr">FORMULA: <span className="text-amber-500">Score = (Benefit × Weight) - (Cost × Risk)</span></div>
